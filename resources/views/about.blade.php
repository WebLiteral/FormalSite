...
<div class='flex flex-col items-center text-center font-cambria '>
    ...
    <h2 class="font-mainmenu text-4xl border-b-2 mb-7 p-2 w-4/5 uppercase">About The Site</h2>
    ...
    <h2 class="font-mainmenu text-4xl border-b-2 mb-7 p-2 w-4/5 uppercase">FAQ</h2>
    <div class="text-left w-4/5">
        <div class="p-4">
            ...
            <p><i>But most importantly: Be kind to others during your usage.</i></p>
        </div>
